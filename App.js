...
function App() {
  ...
  function getMovieData(){
    let url=`https://omdbapi.com/?t=${title}&apikey=d5ec2137`;
      ...
      <div className="container">
          <div className="padd">
            ...
            <div className="input-group">
              <input type="text" placeholder="Enter Movie Name...." onChange={(event)=>readTitle(event.target.value)} className="Field-Search"/>
